...
export default function BluePuzzleSegment(props) {
  ...
  function getImgSrc() {
    ...
    switch (props.getArrowCombination[props.arrowIndex]) {
      case 0: imgSrc = "/images/arrows/arrowDown.png"; break;
      case 1: imgSrc = "/images/arrows/arrowRight.png"; break;
      case 2: imgSrc = "/images/arrows/arrowUp.png"; break;
      case 3: imgSrc = "/images/arrows/arrowLeft.png"; break;
      default: imgSrc = "";
    }
    return imgSrc;
  }
